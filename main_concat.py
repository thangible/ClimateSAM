...
def main():
    ...
    os.system("python script/official/train_adaptation.py --config input_config_concat_2 --sam_type vit_b --image_encoder_mlp_ratio 0.5 --run_name infused_token_vit_b_mlp05_1e2 --lr 1e-2")
    time.sleep(10)
    # INFUSED TEST MLP RATIO VIT B
    os.system("python script/official/train_adaptation.py --config input_config_concat_2 --sam_type vit_b --image_encoder_mlp_ratio 0.75 --lr 1e-4 --run_name infused_token_vit_b_mlp075")
    time.sleep(10)
    os.system("python script/official/train_adaptation.py --config input_config_concat_2 --sam_type vit_b --image_encoder_mlp_ratio 0.5 --lr 1e-4 --run_name infused_token_vit_b_mlp05")
    # INFUSED TEST MLP RATIO VIT L
    os.system("python script/official/train_adaptation.py --config input_config_concat_2 --sam_type vit_l --image_encoder_mlp_ratio 0.5 --lr 1e-3 --run_name infused_token_vit_l_mlp05")
    time.sleep(10)
    os.system("python script/official/train_adaptation.py --config input_config_concat_2 --sam_type vit_l --image_encoder_mlp_ratio 0.75 --lr 1e-4 --run_name infused_token_vit_l_mlp075")
    time.sleep(10)
