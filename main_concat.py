...
def main():
    ...
    os.system("python train_script/official/train_tune_token_concat.py --config input_config_concat_2 --sam_type vit_l  --run_name concat_token_vit_l_mlp075_bce_notrans")
    time.sleep(10)
    os.system("python train_script/official/train_tune_token_concat.py --config input_config_concat_2 --sam_type vit_l --bce_weight 0 --run_name concat_token_vit_l_mlp075_bce0_notrans")
    time.sleep(10)
    os.system("python train_script/official/train_tune_token_concat.py --config input_config_concat_2 --sam_type vit_l --bce_weight 1 --run_name concat_token_vit_l_mlp075_bce1_notrans")
