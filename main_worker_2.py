...
def main():
    ...
    # SINGLE SAM VIT B
    os.system("python train_script/official/train_sam_single.py --config input_config_official --sam_type vit_b --run_name single_sam_vit_b_smooth")
    ...
    time.sleep(15)
    os.system("python train_script/official/train_lora_sam_dual.py --config input_config_official --sam_type vit_b --lora_r 128 --run_name lora_dual_vit_b_r128_smooth --gradient_accumulation_steps 16")
