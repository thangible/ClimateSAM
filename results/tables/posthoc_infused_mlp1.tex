...
\toprule
Prompter & Variant & TC IoU & AR IoU & Mean FG IoU & $\Delta$ FG vs. seed 0 [95\% CI] \\
\midrule
CG-Net (trained from scratch on 358 images) & single seed (mean of seeds) & 0.343 & 0.394 & 0.369 & -- \\
 ...
 & \footnotesize thresholds TC -1.00 / AR -0.75; min. blob 800 / 800 px; max. TC latitude 90$^\circ$ &  &  &  &  \\
\midrule
Logistic regression, ViT block 12 & single seed (mean of seeds) & 0.301 & 0.385 & 0.343 & -- \\
 ...
 & \footnotesize thresholds TC +0.25 / AR +0.25; min. blob 800 / 1600 px; max. TC latitude 45$^\circ$ &  &  &  &  \\
\midrule
Multi-scale fusion & single seed (mean of seeds) & 0.333 & 0.403 & 0.368 & -- \\
 ...
 & \footnotesize thresholds TC +2.75 / AR +0.00; min. blob 50 / 400 px; max. TC latitude 90$^\circ$ &  &  &  &  \\
\midrule
Multi-scale fusion + token gate & single seed (mean of seeds) & 0.324 & 0.399 & 0.362 & -- \\
 ...
 & \footnotesize thresholds TC +1.75 / AR -0.25; min. blob 800 / 400 px; max. TC latitude 90$^\circ$ &  &  &  &  \\
\midrule
Mask-prompt generator (segmentation loss) & single seed (mean of seeds) & 0.344 & 0.413 & 0.379 & -- \\
 ...
 & \footnotesize thresholds TC +2.00 / AR +0.25; min. blob 800 / 200 px; max. TC latitude 90$^\circ$ &  &  &  &  \\
\midrule
Mask-prompt generator (segmentation loss) + CG-Net (trained from scratch on 358 images) & single seed (mean of seeds) & 0.344 & 0.404 & 0.374 & -- \\
 ...
 & \footnotesize thresholds TC -0.75 / AR -0.25; min. blob 800 / 200 px; max. TC latitude 90$^\circ$ &  &  &  &  \\
\midrule
Mask-prompt generator (end-to-end via SAM) & single seed (mean of seeds) & 0.335 & 0.378 & 0.356 & -- \\
 ...
 & \footnotesize thresholds TC +1.50 / AR +0.00; min. blob 800 / 1600 px; max. TC latitude 90$^\circ$ &  &  &  &  \\
\midrule
Mask-prompt generator (two-stage) & single seed (mean of seeds) & 0.338 & 0.409 & 0.374 & -- \\
 ...
 & \footnotesize thresholds TC +1.75 / AR +1.25; min. blob 800 / 200 px; max. TC latitude 90$^\circ$ &  &  &  &  \\
\midrule
Mask-prompt generator (segmentation loss, label smoothing) & single seed (mean of seeds) & 0.338 & 0.412 & 0.375 & -- \\
 ...
 & \footnotesize thresholds TC +0.75 / AR +0.25; min. blob 400 / 1600 px; max. TC latitude 90$^\circ$ &  &  &  &  \\
\midrule
Mask-prompt generator + raw CG-Net fields & single seed (mean of seeds) & 0.340 & 0.409 & 0.375 & -- \\
 ...
 & \footnotesize thresholds TC +1.75 / AR +0.25; min. blob 800 / 1600 px; max. TC latitude 90$^\circ$ &  &  &  &  \\
\bottomrule
\end{tabular}
\end{adjustbox}
\caption{Evaluation-only improvements of the prompter masks (test set). Ensemble: mean of the logits of the three seeds; calibrated: per-class logit threshold chosen on the validation images; post-processed: minimum blob size per class and maximum TC latitude chosen on the validation images; SAM hybrid round $k$: the post-processed mask as hybrid prompt, then SAM's own output fed back as the prompt. $\Delta$: paired bootstrap against the seed-0 prompter mask.}
\label{tab:posthoc_infused_mlp1}
\end{table}
