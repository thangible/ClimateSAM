...
\toprule
Infused Token & Prompt & Comparison (B $-$ A) & $\Delta$ TC [95\% CI] & $\Delta$ AR [95\% CI] & $\Delta$ mean FG [95\% CI] \\
\midrule
...
\end{tabular}
\end{adjustbox}
\caption{Linear versus nonlinear input adapter (Table 4.6) and the effect of the skipped adapter, paired bootstrap over the 61 test images (random prompts: first draw, identical for both models).}
\label{tab:thesis_recheck_adapter_bootstrap}
\end{table}
