...
def main():
    ...
    # time.sleep(10)
    os.system("python train_script/official/train_tune_token_concat.py --config input_config_concat --sam_type vit_l  --image_encoder_mlp_ratio 0.75 --run_name tune_token_concat_vit_l_128_mlp075 --focal_weight 10")
